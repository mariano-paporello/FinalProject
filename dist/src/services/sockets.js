...
var initWsServer = function (server) {
    ...
    SocketServer.on('connection', function (socket) {
        ...
        socket.on("enviarNuevoProducto", function (data) { return __awaiter(void 0, void 0, void 0, function () {
            var prodController, nuevoProducto;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        prodController = new productsController_1.default();
                        return [4 /*yield*/, prodController.newProduct(data)];
                    case 1:
                        nuevoProducto = _a.sent();
        ...
        socket.on('enviarMensaje', function (data) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mensajesController_1.default.nuevomensaje(data)];
                    case 1:
                        dataSi = _a.sent();
