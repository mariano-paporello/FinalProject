...
var initWsServer = function (server) {
    ...
    SocketServer.on("connection", function (socket, req) {
        ...
        socket.on("sendUserPassword", function (data) { return __awaiter(void 0, void 0, void 0, function () {
            var user, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("data:", data);
                        return [4 /*yield*/, user_repository_1.repositoryUser.logIn(data.username, data.password)];
                    case 1:
                        user = _a.sent();
