...
var generateAuthToken = function (user) {
    ...
    var token = jsonwebtoken_1.default.sign(payload, index_1.default.TOKEN_SECRET, { expiresIn: '3m' });
    return token;
};
...
var logIn = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            (0, authenticationController_1.searchUser)(req, username, password, done);
        }
        catch (err) {
...
var signUp = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, authenticationController_1.createUser)(req, username, password, done);
        return [2 /*return*/];
    });
}); };
