...
var searchUser = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.repositoryUser.logIn(username, password)];
            case 1:
                user = _a.sent();
                if (user) {
...
var createUser = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, gmail, age, phoneNumber, image, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                err_1 = _b.sent();
                return [2 /*return*/, done(null, false, { mensaje: 'Error Inesperado', err: err_1 })];
