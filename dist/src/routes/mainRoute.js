...
exports.logged = exports.paths = exports.viewPath = void 0;
...
mainRoute.get('/', LoggedVerification_1.isLogged, LoggedVerification_1.loggedIsNotDestroyed, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        loggers_1.logger.info("METODO:" + req.method + " RUTA:" + req.url);
        (0, viewController_1.homeview)(req, res);
        return [2 /*return*/];
    });
}); });
...
mainRoute.get('/register', function (req, res) {
    loggers_1.logger.info("METODO:" + req.method + " RUTA:" + req.url);
    res.render("register");
});
mainRoute.get("/profile", LoggedVerification_1.isLogged, LoggedVerification_1.loggedIsNotDestroyed, function (req, res) {
