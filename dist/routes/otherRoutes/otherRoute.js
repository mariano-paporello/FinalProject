...
var normalizeController_1 = require("../../Controllers/otherControllers/normalizeController");
var testController_1 = require("../../Controllers/otherControllers/testController");
var minimist_1 = __importDefault(require("minimist"));
var path_1 = __importDefault(require("path"));
var child_process_1 = require("child_process");
var os_1 = __importDefault(require("os"));
var othersRoute = (0, express_1.Router)();
othersRoute.use((0, cookie_parser_1.default)());
othersRoute.use((0, express_session_1.default)(storeOptions_1.storeOptions));
...
othersRoute.get("/normalize", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
...
othersRoute.get("/denormalize", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
...
othersRoute.get("/test-fake-products", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    var _c;
...
othersRoute.get("/info", function (req, res) {
    loggers_1.logger.info("METODO:" + req.method + " RUTA:" + req.url);
    res.json({
...
othersRoute.get("/randoms", function (req, res) {
    loggers_1.logger.info("METODO:" + req.method + " RUTA:" + req.url);
    var cantidad;
    if (req.query.cant) {
