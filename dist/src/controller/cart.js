    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(cartOfUser.cart.filter(function (productInCart) {
                        return productFromProducts.id === productInCart.productId;
                    }))];
            case 1:
...
var productToCartController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, productAñadido, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                if (!(req.params.id.length === 24)) return [3 /*break*/, 4];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, cart_1.getCartByUserId)({
                        userId: dataUser._id,
                    })];
            case 1:
                userHasCart = _a.sent();
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                if (!(idOfUser && id_1.length === 24 && cuantity)) return [3 /*break*/, 9];
            ...
            case 1:
                ...
                if (!(numberOfAmountOfThatProduct &&
                    Number(cuantity) >= numberOfAmountOfThatProduct)) return [3 /*break*/, 3];
            ...
            case 3:
                if (!(numberOfAmountOfThatProduct &&
                    numberOfAmountOfThatProduct > Number(cuantity))) return [3 /*break*/, 5];
                product = {
