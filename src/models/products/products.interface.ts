...
export type DocumentForProductPost = mongoose.Document<
  unknown,
  any,
  { [x: string]: any }
> &
  Omit<{ [x: string]: any } & Required<{ _id: unknown }>, never>;
...
export interface ProductBaseClass {
  ...
  getProductById(
    id: string
  ): Promise<ProductObject | DocumentMongoGet | undefined>;
  getOneProductByQuery(
    query: FilterQuery<ProductObject>
  ): Promise<ProductObject | DocumentMongoGet>;
  getProductsByQuery(
    query: FilterQuery<ProductObject>
