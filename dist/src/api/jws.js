...
var checkAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, tokenReturned;
    return __generator(this, function (_a) {
        try {
            ...
            if (authHeader) {
                ...
                if (!token) {
                    return [2 /*return*/, res.status(403).json({ msg: "Not authorized" })];
                }
                else if (!Array.isArray(token)) {
                    try {
                        tokenReturned = jsonwebtoken_1.default.verify(token, index_1.default.JWT_SECRET_KEY, function (err, user) {
                            if (err) {
                                return false;
                            }
                            else if (user) {
            ...
            return [2 /*return*/, res.status(403).json({ msg: "Error: ".concat(err, " not authorized") })];
        }
        return [2 /*return*/];
    });
}); };
